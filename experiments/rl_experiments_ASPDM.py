...
# def GetEigenoptions(mdp, k=1, sample=False, matrix=None, intToS=None, option_type='subgoal'):
#     if matrix is not None:
#         A = matrix
#     elif sample:
#         A, intToS = GetIncidenceMatrix(mdp)
...
#         return B, options, intToS, vectors
#
#     # TODO: egoal_list is a list of GymStateClass object.
#     #       However, the state is checked as a raw array. Why this happens?
#     egoal_list = [[]] * (len(options) * 2)
#     for i, o in enumerate(options):
#         egoal_list[i * 2] = [intToS[o[0]]]
#         egoal_list[i * 2 + 1] = [intToS[o[1]]]
#
#     # print('egaollist=', egoal_list)
#
#     # for evec in evectors:
#     #     print('evec=', evec)
#     #     print('type(evec)=', type(evec))
